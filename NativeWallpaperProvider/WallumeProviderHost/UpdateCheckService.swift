...
/// Notify-only update check against the public GitHub Releases of WallumeProviderHost.
///
/// WallumeProviderHost distributes notarized DMGs through GitHub Releases (and Homebrew,
