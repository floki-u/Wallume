    ...
    /// empty state on any Mac where WallumeProviderHost isn't the active wallpaper. So the stage fabricates
    ...
    enum ScreenshotGallery {
        ...
        static func present(manager: WallumeProviderHostManager) {
            ...
            let light = makeStage(manager: manager, dark: false, title: "WallumeProviderHost — Stage (Light)")
            let dark = makeStage(manager: manager, dark: true, title: "WallumeProviderHost — Stage (Dark)")
        ...
        private static func makeLibraryStage(manager: WallumeProviderHostManager) -> NSWindow {
            ...
            window.title = "WallumeProviderHost — Library"
        ...
        private static func makeStage(manager: WallumeProviderHostManager, dark: Bool, title: String) -> NSWindow {
    ...
    private struct StageView: View {
        @Bindable var manager: WallumeProviderHostManager
        let dark: Bool
